...
if __name__ == '__main__':
    csv_input = 'E:\\迅雷下载\\VOCtrainval_06-Nov-2007\\VOCdevkit\\VOC2007\\Annotations.csv'#'CSV文件的位置'
    output_path = 'E:\\迅雷下载\\VOCtrainval_06-Nov-2007\\VOCdevkit\\VOC2007\\VOCTrain.tfrecords'#'TFRecords的输出位置及文件名'
    image_path = 'E:\\迅雷下载\\VOCtrainval_06-Nov-2007\\VOCdevkit\\VOC2007\\JPEGImages'#'图像数据的位置'
